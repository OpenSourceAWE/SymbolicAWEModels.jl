...
Compute the full state-space linearization of the model around the current operating
point, from the `LinearizationProblem` generated by `ModelingToolkit.jl`.
...
Numerically compute the Jacobian of a vector-valued function `f` at point `x`, by
