...
#
# Accessors are registered per concrete wing type (e.g. VSMWing, PlateWing)
# because @register_symbolic requires a DataType (not UnionAll).
...
for T in [VSMWing]
    ...
    @eval begin
        # ---- Points ----
        get_pos_w(sys::$ST, idx::Int64) = sys.points[idx].pos_w
        @register_array_symbolic get_pos_w(
            sys::$ST, idx::Int64) begin
            size = (3,)
            eltype = SimFloat
        end
        get_vel_w(sys::$ST, idx::Int64) = sys.points[idx].vel_w
        @register_array_symbolic get_vel_w(
            sys::$ST, idx::Int64) begin
            size = (3,)
            eltype = SimFloat
        end
        get_pos_b(sys::$ST, idx::Int64) = sys.points[idx].pos_b
        @register_array_symbolic get_pos_b(
            sys::$ST, idx::Int64) begin
            size = (3,)
            eltype = SimFloat
        end
        get_va_b(sys::$ST, idx::Int64) = sys.points[idx].va_b
        @register_array_symbolic get_va_b(
            sys::$ST, idx::Int64) begin
            size = (3,)
            eltype = SimFloat
        end
        get_disturb(sys::$ST, idx::Int64) =
        ...
        get_extra_mass(sys::$ST, idx::Int64) =
            sys.points[idx].extra_mass
        @register_symbolic get_extra_mass(
            sys::$ST, idx::Int64)
        get_body_frame_damping(sys::$ST, idx::Int64) =
        ...
        get_world_frame_damping(sys::$ST, idx::Int64) =
        ...
        get_wing_vel_w(sys::$ST, idx::Int64) =
            sys.wings[idx].vel_w
        ...
        get_com_offset_b(sys::$ST, idx::Int64) =
        ...
        get_wing_mass(sys::$ST, idx::Int64) =
            sys.wings[idx].mass
        @register_symbolic get_wing_mass(
            sys::$ST, idx::Int64)
        get_inertia_principal(sys::$ST, idx::Int64) =
        ...
        get_wind_disturb(sys::$ST, idx::Int64) =
        ...
        get_rho_tether(sys::$ST) = sys.set.rho_tether
        @register_symbolic get_rho_tether(sys::$ST)
        get_cd_tether(sys::$ST) = sys.set.cd_tether
        @register_symbolic get_cd_tether(sys::$ST)
        get_g_earth(sys::$ST) = sys.set.g_earth
        @register_symbolic get_g_earth(sys::$ST)
...
# Only registered for SystemStructure{VSMWing}.

get_le_pos(sys::SystemStructure{VSMWing}, idx::Int64) =
...
@register_symbolic get_vsm_jac(
    ...
    ix::Int, iy::Int)
get_twist(sys::SystemStructure{VSMWing}, idx::Int64) =
    sys.groups[idx].twist
@register_symbolic get_twist(
    sys::SystemStructure{VSMWing}, idx::Int64)
get_group_damping(sys::SystemStructure{VSMWing}, idx::Int64) =
    sys.groups[idx].damping
@register_symbolic get_group_damping(
    sys::SystemStructure{VSMWing}, idx::Int64)
get_twist_ω(sys::SystemStructure{VSMWing}, idx::Int64) =
    sys.groups[idx].twist_ω
@register_symbolic get_twist_ω(
    sys::SystemStructure{VSMWing}, idx::Int64)
get_group_y_airf(sys::SystemStructure{VSMWing}, idx::Int64) =
...
get_group_chord(sys::SystemStructure{VSMWing}, idx::Int64) =
...
get_group_le_pos(sys::SystemStructure{VSMWing}, idx::Int64) =
    sys.groups[idx].le_pos
...
get_moment_frac(sys::SystemStructure{VSMWing}, idx::Int64) =
